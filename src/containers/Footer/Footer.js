  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src={svLogo} alt="Saranya Vinjarapu Logo" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/saranya.vinjarapu/"
            ...
            <li>
              <a
                href="https://www.instagram.com/saranyavinjarapu/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/SaranyaWin"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/saranya-vinjarapu-9034b029/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
